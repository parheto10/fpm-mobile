...
class DetailParcelle extends StatefulWidget {
  final Parcelle parcelle;
  final String currentPage;

  const DetailParcelle({Key key, this.parcelle, this.currentPage}) : super(key: key);


  @override
  State<DetailParcelle> createState() => _DetailParcelleState();
}

 var dbHelper = DatabaseHelper();

class _DetailParcelleState extends State<DetailParcelle> {
// Future<Planting> plantings;
  int i = 0;
  int b = 0;
  int c = 0;
  int d = 0;
...
//  void getPlantings() async {
//    this.plantings = dbHelper.getPlantingForParcelle(widget.parcelle.id);
...
//  }
  ...
  Widget build(BuildContext context) {
    // print(dbHelper.getPlantingForParcelle(widget.parcelle.id).length);
    return Scaffold(
        extendBodyBehindAppBar: true,
        appBar: Navbar(
          title: "${widget.parcelle.code}",
          // title: "Profile",
          transparent: true,
        ),
        ...
        body: Stack(children: <Widget>[
          ...
          SafeArea(
            child: ListView(children: [
              Padding(
                padding:
                const EdgeInsets.only(left: 10.0, right: 16.0, top: 70.0),
                child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            //             builder: (context)=>UpdateParcelleForm(parcelle: widget.parcelle,))
                                            //         );
                                            //     },
                                            //   child: Text(
                                            //     "Modifier",
                                            ...
                                            // ),
                                             Container(
                                               height: 38.0,
                                              decoration: BoxDecoration(
                                                color: Color.fromARGB(255, 99, 235, 94),
                                                borderRadius:
                                                BorderRadius.circular(10.0),
                                                boxShadow: [
                                                  BoxShadow(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Column(
                                              children: [
                                                Text("${widget.parcelle.superficie} Ha",
                                                    style: TextStyle(
                                            ...
                                            Column(
                                              children: [
                                                Text("${widget.parcelle.certification}",
                                                    style: TextStyle(
                                                        color: Color.fromRGBO(
                                                            82, 95, 127, 1),
                                                        fontSize: 20.0,
                                        ...
                                        Align(
                                          ...
                                          child: Text("${widget.parcelle.code_certificat}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 28.0)),
                                        ...
                                        SizedBox(height: 5.0),
                                        Align(
                                          child: Text("Code : ${widget.parcelle.code}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        SizedBox(height: 10.0),
                                        Align(
                                          child: Text("Coord : (${widget.parcelle.latitude}, ${widget.parcelle.longitude})",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        SizedBox(height: 10.0),
                                        Align(
                                          child: Text("Propriétaire : ${widget.parcelle.nom}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        Padding(
                                          ...
                                          child: Align(
                                            child: Text(
                                                "Parcelle Certifié en ${widget.parcelle.annee_certificat != null ?widget.parcelle.annee_certificat : "" }",
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: const <Widget>[
              Text('Vous ne pouvez pas modifier cette parcelle'),
