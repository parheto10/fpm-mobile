                                  ...
                                  Expanded(
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(height: 5.0),
                                        Align(
                                          child: Text("Code : ${producteur.code}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        Align(
                                          child: Text("Localité : ${producteur.localite}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        Align(
                                          child: Text("Origine : ${producteur.origine_id}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        SizedBox(height: 5.0),
                                        Align(
                                          child: Text("Coopérative : ${producteur.cooperative_id}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        SizedBox(height: 10.0),
                                        Align(
                                          child: Text("Section : ${producteur.section_id}",
                                              style: TextStyle(
                                                  color: Color.fromRGBO(
                                                      50, 50, 93, 1),
                                                  fontSize: 18.0,
                                        ...
                                        Padding(
                                          ...
                                          child: Align(
                                            child: Text(
                                                "Détail Supplémentaire sur le Producteur en 1 ou 2 lignes",
